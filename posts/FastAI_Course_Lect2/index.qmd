...
author: "Kanav Sharma"
date: "2024-04-09"
categories: [Deep Learning, Computer Vision, FastAI]
toc: true
#image: "image.jpg"
...
1.   Create dynamic path according to there name store file
...
You can access live model [here](https://huggingface.co/spaces/mekanavsharma/minima) deployed using Hugging Face & gradio.
Wanna know how to do it ? refer [Gradio-HuggingFace](https://www.tanishq.ai/blog/posts/2021-11-16-gradio-huggingface.html).
