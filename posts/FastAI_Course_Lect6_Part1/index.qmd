...
2.  New Images : Here we are using Images that most probabily are not in **ImagNet** dataset, like Satellite Images, Medical Images etc.
...
### Standardise the size of Images
...
We can see that we have lot's of different size of images. We need to standardised it.
